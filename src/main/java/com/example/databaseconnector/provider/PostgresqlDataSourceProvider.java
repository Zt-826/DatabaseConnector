...
public class PostgresqlDataSourceProvider extends AbstractDataSourceProvider {
    ...
    @Value("${datasource.postgresql.strategy}")
    private String strategy;

    @Override
    public MultiDataSource createDataSource() {
        // 获取数据源信息
        JSONArray dataSourceInfo = dataSourceConfigService.getDataSourceInfo(POSTGRESQL);
        ...
        multiDataSource.setDataSourceType(DatabaseType.Postgresql);
